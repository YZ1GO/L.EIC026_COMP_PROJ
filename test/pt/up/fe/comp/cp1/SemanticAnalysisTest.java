...
public class SemanticAnalysisTest {
    ...
    public void arrayAccessCorrect() {
        var result = TestUtils
                .analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/ArrayAssignCorrect.jmm"));
        TestUtils.noErrors(result);
    }

    @Test
    public void arrayAccessWrong() {
        var result = TestUtils
                .analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/ArrayAssignWrong.jmm"));
        TestUtils.mustFail(result);
        System.out.println(result.getReports());
    }
}
